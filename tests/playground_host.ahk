...
; you get the real floating panel (Ctrl+Shift+B) with the CPRS dropdown
; (Save / Load / Delete), Settings etc. You then drive it by hand against the
; fake dialog exactly like you would against real CPRS - save a template off the mock,
